...
export function Footer() {
  ...
  return (
    <footer className="site-footer" style={{ background: T.green900, color: 'rgba(255,255,255,0.65)', padding: '64px 24px 32px' }} role="contentinfo">
      <div style={{ maxWidth: 1200, margin: '0 auto' }}>
        <div className="footer-grid" style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(200px, 1fr))', gap: 40, marginBottom: 56, paddingBottom: 40, borderBottom: '1px solid rgba(255,255,255,0.08)' }}>
          {/* Brand */}
          <div>
            <div className="footer-brand" style={{ display: 'flex', alignItems: 'center', gap: 8, marginBottom: 14 }}>
          ...
          <div>
            ...
            {/* Social */}
            <div className="footer-social" style={{ display: 'flex', justifyContent: 'start', gap: 12 }}>
              {[
